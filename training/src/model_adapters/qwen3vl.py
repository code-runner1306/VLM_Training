...
class Qwen3VLAdapter(BaseVLMAdapter):
    """
    Adapter for Qwen3-VL 8B-class models.
    Provides forward-compatible interface when official Qwen3-VL HF identifiers/classes are released,
    falling back seamlessly to AutoModelForCausalLM / Qwen2_5_VL structure.
    """
    ...
    def load_model_and_processor(
        ...
        max_pixels = self.config.get("image", {}).get("max_pixels", 1600 * 28 * 28)
    ...
    def get_target_modules(self, strategy: str) -> List[str]:
        ...
        projector_modules = ["merger.mlp.0", "merger.mlp.2", "multi_modal_projector"]
        vision_modules = ["visual.blocks", "vision_tower"]
